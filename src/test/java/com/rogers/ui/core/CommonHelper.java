...
public class CommonHelper extends Core {
	...
	public void takeScreenshot() {
		screenShoot = new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(getLocalDriver());
		try {
	...
	/**
	 * @param url
	 *            <b>Description</b> Launches the browser and direct to the given
	 *            url
	 * @throws Exception
	 */
	 ...
	 * @param by
	 * @param indexNumber
	 *            <b>Description</b> Gets an element at indexNumber for elements
	 *            located by "by"
	 * @return WebElement
	 */
	 ...
	 * @param by
	 * @param selection
	 *            <b>Description</b> Selects selection from a dropdown
	 */
	...
	/**
	 * @param by
	 *            <b>Description</b> Checks the checkbox
	 */
	...
	/**
	 * @param frameId
	 *            <b>Description</b> Switch to the frame with provided Id
	 */
	...
	/**
	 * @param frameId
	 *            <b>Description</b> Switch to the frame with provided index
	 */
	...
	/**
	 * @param frameId
	 *            <b>Description</b> Switch to the frame with provided locator
	 */
